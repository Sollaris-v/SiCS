...
import com.example.sics.activity.adapter.EmAndamentoAdapter;
 ...
 * {@link EmAndamentoFragment.OnFragmentInteractionListener} interface
...
public class EmAndamentoFragment extends Fragment {
    ...
    private EmAndamentoAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Configurar adapter
        adapter = new EmAndamentoAdapter(listaFechados, getActivity());
    ...
    public void onStart() {
        ...
        super.onStart();
        EmAndamentoAdapter.clearData();  // IMPEDE DA LISTA SE REPETIR
        ...
        usuarioRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if (nivelUsuario.equals("administrador")){
                    ...
                    chamadosFechados = chamado.orderByChild("estado").equalTo("em andamento");
                    ...
                    if (especialidadeUsuario.equals("tecnico de celular")){
                        ...
                        DatabaseReference chamado = referencia.child("chamados");
                        chamadosFechados = chamado.orderByChild("estado_tipo").equalTo("em andamento_problema com o celular");
                        ...
                        DatabaseReference chamado = referencia.child("chamados");
                        chamadosFechados = chamado.orderByChild("estado_tipo").equalTo("em andamento_problema com computador");
                    ...
                    //RECUPERA CHAMADO
                    DatabaseReference chamado = referencia.child("chamados");
                    chamadosFechados = chamado.orderByChild("estado_idcli").equalTo("em andamento_"+idUsuario);
